				...
				if (data.length > 0){
					...
					for (var i = 0; i < data.length; i++) {
						...
						table.find('.btn-maisInformacoes').on('click', function(){
							...
							modal.find('.modal-local-evento-nome').val(infoEvento.local.nome + ", " + infoEvento.local.descricao + ", Capacidade: " + infoEvento.local.capacidade);
							modal.find('.modal-local-evento-capacidade').val(infoEvento.local.capacidade);
							modal.find('.modal-strategia-evento').val(infoEvento.strategia.descricao);
